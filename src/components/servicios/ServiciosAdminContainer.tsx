    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 border border-slate-200 rounded-2xl shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <button
          ...
          className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-white text-xs font-bold rounded-xl px-4 py-2 flex items-center justify-center gap-1.5 cursor-pointer shadow-lg shadow-primary/10 hover:shadow-primary/20 transition-all"
        >
          <Plus size={14} />
